    ...
    return(
        <header className={styles.header} >
            ...
            <select className={styles['select-race']} name="Select the Race" onChange={raceSelected}>
                <option selected disabled> Select by Race</option>
                ...
                <option value="Vampire,Half-elven,Stone-trolls,Balrog,Werewolves,Urulóki,Wraith,Great Spiders,Horse">This List Goes On</option>
            </select>
